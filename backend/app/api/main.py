...
from .endpoints import health, claude_pm, tasks, task_decomposition, agent_communication, cli, workstreams
...
api_router.include_router(workstreams.router, prefix="/workstreams", tags=["workstreams"])
